...
(function () {
    ...
    angular.module('web.controllers').factory('EDID_Obj', [
        ...
        'deviceModel',
        'K_Port',
        function ($http, $q, edidReaderServiceFactory, $filter,deviceModel, K_Port) {
    ...
    angular.module('web.controllers').controller('edidCtrl', [
        ...
        function ($rootScope,
                  ...
                  fileTransferServiceFactory,
                  edidCollectorServiceFactory,
                  $log, EDID_Obj, $http, deviceModel, Commands, K_Proxy, MessageService, $filter) {
...
//For IE10 compatibility use getAttribute instead of dataset
    ...
    angular.module('web.controllers').directive("kEdidCopyButton", [
        ...
        'EDID_Obj',
        '$exceptionHandler',
        function (deviceModel, EDID_Obj, $exceptionHandler) {
            return {
                restrict: 'E',
                scope: {
                    enabled: '='
