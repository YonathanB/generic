(function () {
    ...
    KApp.controller('operationalConfigurationCtrl', [
        ...
        // 'authentication',
        '$timeout',
        function ($scope, deviceModel, Commands, model, $timeout) {
    ...
    KApp.controller('operationalRecordingCtrl', [
        ...
        '$timeout',
        '$filter',
        function ($scope, deviceModel, Commands, model, $timeout, $filter) {
    ...
    KApp.controller('operationalTunnelingCtrl', [
        ...
        '$timeout',
        '$sce',
        function ($scope, deviceModel, Commands, model, $timeout, $sce) {
